...
class CupertinoDatePicker extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _CupertinoDatePickerDateTimeState();
...
class _CustomCupertinoTimerPickerState
  ...
  int get textDirectionFactor {
    return {TextDirection.ltr: 1, TextDirection.rtl: -1}[textDirection]!;
  }
  ...
  Widget _buildLabel(String text, EdgeInsetsDirectional pickerPadding) {
    ...
    const extraPadding = EdgeInsets.only(left: 8);
    final pref = {'hours': 'h', 'min.': 'm', 'sec.': 's'}[text];

    return IgnorePointer(
      child: Container(
        padding: padding.resolve(textDirection).add(extraPadding),
